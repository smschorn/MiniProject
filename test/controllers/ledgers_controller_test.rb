...
class LedgersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ledger" do
    assert_difference('Ledger.count') do
      post ledgers_url, params: { ledger: { month: @ledger.month, user_id: @ledger.user_id, year: @ledger.year } }
    end
  ...
  test "should update ledger" do
    patch ledger_url(@ledger), params: { ledger: { month: @ledger.month, user_id: @ledger.user_id, year: @ledger.year } }
